...
export type HomeQueryQuery = { __typename?: 'Query', starredRoutes: Array<{ __typename?: 'Route', id: any, name: string, distance: number, elevationAscentM: number, elevationDescentM: number, points: Array<Array<number>> }> };
