...
export type HomeQueryQuery = { __typename?: 'Query', queryRoutes: Array<{ __typename?: 'Route', id: any, name: string, distance: number, isMetaComplete: boolean, elevationAscentM: number, elevationDescentM: number, samplePoints: Array<Array<number>> }> };
